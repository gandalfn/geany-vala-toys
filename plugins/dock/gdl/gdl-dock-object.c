...
{
    static volatile gsize gdl_object_type_id__volatile = 0;
    if (gdl_object_type_id__volatile == 0 && g_once_init_enter (&gdl_object_type_id__volatile))
    {
        GTypeInfo tinfo = { 0, };
        GType gdl_object_type_id = g_type_register_static (G_TYPE_STRING, "GdlDockParam", &tinfo, 0);

        /* register known transform functions */
        /* exporters */
        g_value_register_transform_func (G_TYPE_INT, gdl_object_type_id, gdl_dock_param_export_int);
        g_value_register_transform_func (G_TYPE_UINT, gdl_object_type_id, gdl_dock_param_export_uint);
        g_value_register_transform_func (G_TYPE_STRING, gdl_object_type_id, gdl_dock_param_export_string);
        g_value_register_transform_func (G_TYPE_BOOLEAN, gdl_object_type_id, gdl_dock_param_export_bool);
        g_value_register_transform_func (GDL_TYPE_DOCK_PLACEMENT, gdl_object_type_id, gdl_dock_param_export_placement);
        /* importers */
        g_value_register_transform_func (gdl_object_type_id, G_TYPE_INT, gdl_dock_param_import_int);
        g_value_register_transform_func (gdl_object_type_id, G_TYPE_UINT, gdl_dock_param_import_uint);
        g_value_register_transform_func (gdl_object_type_id, G_TYPE_STRING, gdl_dock_param_import_string);
        g_value_register_transform_func (gdl_object_type_id, G_TYPE_BOOLEAN, gdl_dock_param_import_bool);
        g_value_register_transform_func (gdl_object_type_id, GDL_TYPE_DOCK_PLACEMENT, gdl_dock_param_import_placement);

        g_once_init_leave (&gdl_object_type_id__volatile, gdl_object_type_id);
    }

    return gdl_object_type_id__volatile;
}
...
gdl_dock_object_register_init (void)
{
    ...
    g_relation_insert (dock_register, "bar", (gpointer) GDL_TYPE_DOCK_BAR);
}
